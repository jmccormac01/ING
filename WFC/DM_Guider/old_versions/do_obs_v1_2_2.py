...
#
#   Usage:
#      python do_obs.py exposure_time [directory for data]
#
#   By default it will use the latest directory in /obsdata/inta/
#
import numpy as np
import pyfits as pf
...
n_arg=np.size(args)
if len(sys.argv) < 2:
   print("USAGE: python do_obs.py exposure_time [directory for data] \n")
   sys.exit(1)
if n_arg !=3:
   if n_arg != 2:
      texp=10.
